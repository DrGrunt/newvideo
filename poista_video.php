  ...
  <body style="background-color:#90fff8;">
    ...
    <div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form class="form-horizontal" action="poista_video.php" method="post">
                      <input type="hidden" name="id" value="<?php echo $id;?>"/>
                      <p class="alert alert-error">Haluatko poistaa videon, <?php echo $data['nimi'] ?>?</p>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-danger">Kyllä</button>
                          <a class="btn btn-outline-black" href="video.php">En</a>
                        </div>
                    </form>
                </div>
